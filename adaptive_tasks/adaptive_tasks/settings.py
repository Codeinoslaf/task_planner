"""
Django settings for adaptive_tasks project.
...
ROOT_URLCONF = 'adaptive_tasks.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'tasks' / 'templates'],  # ← добавь эту строку
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'adaptive_tasks.wsgi.application'
